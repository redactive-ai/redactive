...
export const TimeSpan = {
  encode(message: TimeSpan, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.after !== undefined) {
      Timestamp.encode(toTimestamp(message.after), writer.uint32(10).fork()).ldelim();
    }
    if (message.before !== undefined) {
      Timestamp.encode(toTimestamp(message.before), writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): TimeSpan {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
function createBaseFilters(): Filters {
  return { scope: [], created: undefined, modified: undefined, userEmails: [] };
}
...
export const Filters = {
  encode(message: Filters, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.created !== undefined) {
      TimeSpan.encode(message.created, writer.uint32(18).fork()).ldelim();
    }
    if (message.modified !== undefined) {
      TimeSpan.encode(message.modified, writer.uint32(26).fork()).ldelim();
    }
...
export const QueryResponse = {
  encode(message: QueryResponse, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    for (const v of message.relevantChunks) {
      RelevantChunk.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
