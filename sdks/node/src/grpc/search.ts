...
export interface DocumentNameQuery {
...
export interface QueryByDocumentNameRequest {
  /** The query to execute */
  query: DocumentNameQuery | undefined;
  /** Filters to apply to query */
  filters?: Filters | undefined;
}

export interface QueryByDocumentNameResponse {
  /** Query was successful */
  success: boolean;
  /** Error message if query failed */
  error?: { [key: string]: any } | undefined;
...
function createBaseDocumentNameQuery(): DocumentNameQuery {
  return { documentName: "" };
}

export const DocumentNameQuery: MessageFns<DocumentNameQuery> = {
  encode(message: DocumentNameQuery, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DocumentNameQuery {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseDocumentNameQuery();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): DocumentNameQuery {
    return { documentName: isSet(object.documentName) ? globalThis.String(object.documentName) : "" };
  },

  toJSON(message: DocumentNameQuery): unknown {
    const obj: any = {};
    if (message.documentName !== "") {
  ...
  create<I extends Exact<DeepPartial<DocumentNameQuery>, I>>(base?: I): DocumentNameQuery {
    return DocumentNameQuery.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DocumentNameQuery>, I>>(object: I): DocumentNameQuery {
    const message = createBaseDocumentNameQuery();
...
export const GetChunksByUrlRequest: MessageFns<GetChunksByUrlRequest> = {
...
export const GetChunksByUrlResponse: MessageFns<GetChunksByUrlResponse> = {
...
function createBaseQueryByDocumentNameRequest(): QueryByDocumentNameRequest {
  return { query: undefined, filters: undefined };
}

export const QueryByDocumentNameRequest: MessageFns<QueryByDocumentNameRequest> = {
  encode(message: QueryByDocumentNameRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      DocumentNameQuery.encode(message.query, writer.uint32(18).fork()).join();
    }
    if (message.filters !== undefined) {
      Filters.encode(message.filters, writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryByDocumentNameRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryByDocumentNameRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 2:
          ...
          message.query = DocumentNameQuery.decode(reader, reader.uint32());
          continue;
        case 3:
          if (tag !== 26) {
            break;
  ...
  fromJSON(object: any): QueryByDocumentNameRequest {
    return {
      query: isSet(object.query) ? DocumentNameQuery.fromJSON(object.query) : undefined,
      filters: isSet(object.filters) ? Filters.fromJSON(object.filters) : undefined
    };
  },

  toJSON(message: QueryByDocumentNameRequest): unknown {
    const obj: any = {};
    if (message.query !== undefined) {
      obj.query = DocumentNameQuery.toJSON(message.query);
    }
    if (message.filters !== undefined) {
      obj.filters = Filters.toJSON(message.filters);
    }
  ...
  create<I extends Exact<DeepPartial<QueryByDocumentNameRequest>, I>>(base?: I): QueryByDocumentNameRequest {
    return QueryByDocumentNameRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryByDocumentNameRequest>, I>>(object: I): QueryByDocumentNameRequest {
    const message = createBaseQueryByDocumentNameRequest();
    message.query =
      object.query !== undefined && object.query !== null ? DocumentNameQuery.fromPartial(object.query) : undefined;
    message.filters =
      object.filters !== undefined && object.filters !== null ? Filters.fromPartial(object.filters) : undefined;
    return message;
  }
...
function createBaseQueryByDocumentNameResponse(): QueryByDocumentNameResponse {
  return { success: false, error: undefined, chunks: [] };
}

export const QueryByDocumentNameResponse: MessageFns<QueryByDocumentNameResponse> = {
  encode(message: QueryByDocumentNameResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.success !== false) {
      writer.uint32(8).bool(message.success);
    }
    if (message.error !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryByDocumentNameResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseQueryByDocumentNameResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): QueryByDocumentNameResponse {
    return {
      success: isSet(object.success) ? globalThis.Boolean(object.success) : false,
      error: isObject(object.error) ? object.error : undefined,
      chunks: globalThis.Array.isArray(object?.chunks) ? object.chunks.map((e: any) => Chunk.fromJSON(e)) : []
  ...
  toJSON(message: QueryByDocumentNameResponse): unknown {
    const obj: any = {};
    if (message.success !== false) {
      obj.success = message.success;
    }
  ...
  create<I extends Exact<DeepPartial<QueryByDocumentNameResponse>, I>>(base?: I): QueryByDocumentNameResponse {
    return QueryByDocumentNameResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<QueryByDocumentNameResponse>, I>>(object: I): QueryByDocumentNameResponse {
    const message = createBaseQueryByDocumentNameResponse();
    message.success = object.success ?? false;
    message.error = object.error ?? undefined;
    message.chunks = object.chunks?.map((e) => Chunk.fromPartial(e)) || [];
...
export const SearchService = {
  ...
  queryChunksByDocumentName: {
    path: "/redactive.grpc.v1.Search/QueryChunksByDocumentName",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: QueryByDocumentNameRequest) =>
      Buffer.from(QueryByDocumentNameRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer) => QueryByDocumentNameRequest.decode(value),
    responseSerialize: (value: QueryByDocumentNameResponse) =>
      Buffer.from(QueryByDocumentNameResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer) => QueryByDocumentNameResponse.decode(value)
  },
  /** Get chunks by URL */
  getChunksByUrl: {
...
export interface SearchServer extends UntypedServiceImplementation {
  ...
  /** Query the index for all chunks of a specific document */
  queryChunksByDocumentName: handleUnaryCall<QueryByDocumentNameRequest, QueryByDocumentNameResponse>;
  /** Get chunks by URL */
...
export interface SearchClient extends Client {
  ...
  /** Query the index for all chunks of a specific document */
  queryChunksByDocumentName(
    request: QueryByDocumentNameRequest,
