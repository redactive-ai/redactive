...
export const ChunkMetadata = {
  encode(message: ChunkMetadata, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.modifiedAt !== undefined) {
      Timestamp.encode(toTimestamp(message.modifiedAt), writer.uint32(18).fork()).ldelim();
    }
...
export const SourceReference = {
  encode(message: SourceReference, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.system !== "") {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SourceReference {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ChunkReference = {
  encode(message: ChunkReference, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ChunkReference {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RelevantChunk = {
  encode(message: RelevantChunk, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.source !== undefined) {
      SourceReference.encode(message.source, writer.uint32(10).fork()).ldelim();
    }
    if (message.chunk !== undefined) {
      ChunkReference.encode(message.chunk, writer.uint32(18).fork()).ldelim();
    }
    if (message.relevance !== undefined) {
      RelevantChunk_Relevance.encode(message.relevance, writer.uint32(26).fork()).ldelim();
    }
    if (message.chunkBody !== "") {
      writer.uint32(34).string(message.chunkBody);
    }
    if (message.documentMetadata !== undefined) {
      ChunkMetadata.encode(message.documentMetadata, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): RelevantChunk {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const RelevantChunk_Relevance = {
  encode(message: RelevantChunk_Relevance, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): RelevantChunk_Relevance {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
